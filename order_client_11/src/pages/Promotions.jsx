            ...
            <div className="promotions-page-content">
                        ...
                        <div className="promotions-upload-box">
                            {imagePreview ? (
                                <>
                                    ...
                                    />
                                    <div className="promotions-preview-overlay">Click to replace image</div>
                                </>
                            ) : (
                                <>
                                    ...
                                    <span className="promotions-upload-hint">PNG, JPG, or WEBP</span>
                                </>
                            )}
                ...
                <div className="promotions-list-container">
                    <div className="promotions-list-header">
                        <div>
                            <span className="promotions-eyebrow">Live library</span>
                            <h2 className="promotions-list-title">Active Promotions</h2>
                        </div>
                        <span className="promotions-count">{promotions.length} total</span>
                    </div>
