// src/pages/MenuLogin.js
import React, { useState } from "react";
import { useNavigate } from "react-router-dom";
import { verifySectionPasscode, getAuthInfo } from "../firebase";
import routes from "../routes";

export default function MenuLogin() {
  const [pin, setPin] = useState("");
  const [authInfo, setAuthInfo] = useState({ isAnonymousSignedIn: false, lastAuthError: null });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error("Error during menu login:", error);
  ...
  return (
    <div className="sub-login">
      ...
      <aside className="sub-login-left" aria-hidden="false">
        ...
        <div className="sub-illustration">
          <div className="sub-circle-outer" aria-hidden="true">
            ...
            <div className="sub-food-img" aria-hidden="true">
              <span></span>
              <span></span>
              <span></span>
            </div>
      ...
      <div className="sub-red-blob" aria-hidden="true"></div>
    </div>
  );
}
