...
// fixed-length input (India-only, up to 15 raw digits sliced but with no
// real minimum-length validation). This utility relaxes input handling to
// accept common international formatting while still rejecting garbage.
//
// NOTE: this file is intentionally duplicated (not shared) from the admin
// app at order_clients-Maroon/src/utils/phoneValidation.js — these two
