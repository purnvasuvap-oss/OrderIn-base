// Shared interpretation of menu-item Firestore fields, used by both the
// authenticated Menu page (src/menu/Menu.jsx) and the pre-login public
// flipbook menu (src/publicMenu/*), so the two never drift out of sync.
// Relocated here from Menu.jsx — same logic, same behavior, just shared.
