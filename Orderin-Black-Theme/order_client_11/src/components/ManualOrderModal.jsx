...
function ManualOrderModal({ isOpen, onClose, menuItems, onOrderCreated, initialTableNumber = "" }) {
  ...
  // Live preview only — the authoritative subtotal/tax/totalCost used for the
  // Firestore write is recomputed independently in handleSubmit.
      ...
      <div className="manual-order-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-footer">
          <div className="manual-order-total">
            ...
            {orderSubtotal > 0 && (
              <small>Subtotal ₹{orderSubtotal} + tax ₹{orderTax}</small>
            )}
          </div>
          <button
