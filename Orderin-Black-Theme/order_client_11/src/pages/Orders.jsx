...
function Orders() {
  ...
  const statCards = [
    { key: "all", label: "Total Orders", cap: "Last 24 hours", count: total, color: "#ef4444", icon: null },
    { key: "queued", label: "Queued", cap: "Awaiting accept / payment", count: queued, color: "#2F6FB0", icon: null },
    { key: "active", label: "Active", cap: "In the kitchen", count: active, color: "#B5823F", icon: null },
    { key: "completed", label: "Served", cap: "Delivered today", count: completed, color: "#3FA34D", icon: null },
