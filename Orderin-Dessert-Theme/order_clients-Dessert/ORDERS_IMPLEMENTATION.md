...
### Data Structure
Orders are stored in Firebase at: `/Restaurant/orderin_restuarant_5/customers/<phone_number>/pastOrders`
...
### Read Path
- Collection: `Restaurant/orderin_restuarant_5/customers`
...
- Reading from `/Restaurant/orderin_restuarant_5/customers/{phoneNumber}`
- Writing to `/Restaurant/orderin_restuarant_5/customers/{phoneNumber}/pastOrders`

Example rule:
```javascript
match /Restaurant/orderin_restuarant_5/customers/{phoneNumber} {
