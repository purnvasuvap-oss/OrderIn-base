...
// Ported from the Olive Green admin app's RejectReasonModal: staff pick a
// preset reason (or none is selected and Confirm stays disabled) before an
// order is actually rejected, so the customer gets told why.
