...
const Promotions = () => {
    ...
    const fetchPromotions = async () => {
        try {
            ...
            const promotionsRef = collection(db, 'Restaurant', 'orderin_restaurant_1', 'promotions');
                            ...
                            {promotions.map((promo) => (
                                <div key={promo.id} className="promotion-card">
                                    <div className="promotion-image-container">
                                        ...
                                        >
                                            <FiTrash2 size={16} className="promotion-delete-icon" />
                                            <span className="promotion-delete-fallback" aria-hidden="true">🗑</span>
                                        </button>
                                    </div>
