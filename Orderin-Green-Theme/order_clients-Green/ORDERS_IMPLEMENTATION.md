...
### Data Structure
Orders are stored in Firebase at: `/Restaurant/orderin_restuarant_6/customers/<phone_number>/pastOrders`
...
### Read Path
- Collection: `Restaurant/orderin_restuarant_6/customers`
...
- Reading from `/Restaurant/orderin_restuarant_6/customers/{phoneNumber}`
- Writing to `/Restaurant/orderin_restuarant_6/customers/{phoneNumber}/pastOrders`

Example rule:
```javascript
match /Restaurant/orderin_restuarant_6/customers/{phoneNumber} {
