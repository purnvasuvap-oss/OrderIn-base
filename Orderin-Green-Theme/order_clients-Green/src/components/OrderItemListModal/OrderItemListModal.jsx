...
/**
 * Ported from the Olive Green admin app's Orders "Items List" modal.
 * Aggregates an order's raw item list by name + instructions (summing
 * quantity/subtotal per unique line) and shows an Item / Qty / Price /
 * Total / Instructions breakdown plus subtotal/tax/total footer.
 */
