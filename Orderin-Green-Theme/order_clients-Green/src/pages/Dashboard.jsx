  ...
  return (
    <div className="dashboard-wrapper">
      ...
      <div className="modules-grid">
        ...
        <div className="module-card kitchen-module" onClick={goTo(routes.kitchen)}>
          <div className="module-badge">
            <DoorOpen size={12} />
            <span>Open to all</span>
          </div>
          <div className="module-top">
            ...
            <div>
              ...
              <p>Full-screen order board for the kitchen line.</p>
            </div>
          </div>

          <div className="module-bottom yellow-text">Open Kitchen Display →</div>
        </div>
